sap.ui.define([
	...
	return BaseObject.extend("ModelCrud.model.GroupSortState", {
		 ...
		 * @class
		 * @public
		 * @alias ModelCrud.model.GroupSortState
		 */
		...
		group: function(sKey) {
			...
			if (sKey === "") {
				...
				this._oViewModel.setProperty("/sortBy", "MODEL_ID");
			}
