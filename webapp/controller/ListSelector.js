sap.ui.define([
	...
	return BaseObject.extend("ModelCrud.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias ModelCrud.model.ListSelector
		 */
		 ...
		 * @return {ModelCrud.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
