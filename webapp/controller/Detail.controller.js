...
sap.ui.define([
	...
	"ModelCrud/model/formatter",
	"sap/m/MessageBox",
	"sap/m/MessageToast"
], function(BaseController, JSONModel, formatter, MessageBox, MessageToast) {
	"use strict";

	return BaseController.extend("ModelCrud.controller.Detail", {
		...
		onDelete: function() {
			...
			var oViewModel = this.getModel("detailView"),
				...
				sObjectHeader = this._oODataModel.getProperty(sPath + "/MODEL_ID"),
		...
		_onObjectMatched: function(oEvent) {
			...
			this.getModel().metadataLoaded().then(function() {
				var sObjectPath = this.getModel().createKey("P_MODEL", oParameter);
			...
			this.getView().bindElement({
				...
				events: {
					...
					dataReceived: function() {
						oViewModel.setProperty("/busy", false);
						var mySelectMenuMODEL = sap.ui.getCore().byId("mySelectMenuPurposeI");
            			mySelectMenuMODEL.setSelectedKey(sap.ui.getCore().byId("inputPurposeI").getValue());
					}
				}
			});
		},
		...
		_onBindingChange: function() {
			...
			var sPath = oElementBinding.getBoundContext().getPath(),
				...
				sObjectId = oObject.MODEL_ID,
				sObjectName = oObject.MODEL_ID;
