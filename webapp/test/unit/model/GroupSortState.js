sap.ui.define([
	"ModelCrud/model/GroupSortState",
	...
	QUnit.test("Should always return a sorter when sorting", function(assert) {
		...
		assert.strictEqual(this.oGroupSortState.sort("MODEL_ID").length, 1, "The sorting by MODEL_ID returned a sorter");
	});
	...
	QUnit.test("Should set the grouping to None if the user sorts by MODEL_ID and there was a grouping before", function(assert) {
		// Arrange
		this.oModel.setProperty("/groupBy", "");

		this.oGroupSortState.sort("MODEL_ID");
